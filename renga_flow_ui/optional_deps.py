...
from renga_flow.cli.training_extras import ensure_profiles, profile_installed
...
from renga_flow.install_profiles import normalize_profiles as normalize_install_profiles
        ...
        rows.append(
            {
                ...
                "command": renga_init_command([sync_key]),
