...
PROFILE_LABELS: dict[str, str] = {
    ...
    "kaon": "K-Optimizers (Adakaon, AdaMuon, KProdigy, Lion, AdaPNM, AdaBelief, AdamP, ADOPT, ScheduleFree, Lookahead, SAM, MSAM, Nekaon, Rakaon)",
...
PROFILE_DESCRIPTIONS: dict[str, str] = {
    ...
    "kaon": "Memory-efficient optimizers (Adakaon, AdaMuon, KProdigy, Lion, AdaPNM, AdaBelief, AdamP, ADOPT, ScheduleFree, Lookahead, SAM, MSAM, Nekaon, Rakaon) from github.com/Koronos/K-Optimizers.",
