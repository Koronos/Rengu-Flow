"""``renga train`` and training shortcuts."""
...
from renga_flow.cli.train_launcher import build_train_command, training_subprocess_env
from renga_flow.cli.training_extras import ensure_training_extras
from renga_flow.config.local_config import ensure_local_config_loaded
...
def add_parser(sub: argparse._SubParsersAction) -> None:
    ...
    p.add_argument(
        ...
        help="Extra args passed to renga_flow.main",
    )
