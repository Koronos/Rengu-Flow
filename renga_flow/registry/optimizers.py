...
VENDOR_OPTIMIZER_ALIASES: dict[str, tuple[str, str]] = {
    "genericoptim": (
        "renga_flow.vendor.diffusion_pipe_optimizers.generic_optim",
        "GenericOptim",
    ),
    "automagic": (
        "renga_flow.vendor.diffusion_pipe_optimizers.automagic",
        "Automagic",
    ),
    "adamw8bitkahan": (
        "renga_flow.vendor.diffusion_pipe_optimizers.adamw_8bit",
        "AdamW8bitKahan",
    ),
}
