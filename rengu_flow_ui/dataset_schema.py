...
def get_directory_fields() -> list[dict[str, Any]]:
    ...
    return [
        ...
        _field(
            "no_upscale",
            "No upscale (re-bucket down)",
            "boolean",
            default=False,
            description="With size buckets, never enlarge: assign an image to the largest bucket it fills.",
        ),
        _field(
            "drop_undersized",
            ...
            "boolean",
            default=False,
            description="With no upscale, discard images too small for any bucket instead of using the smallest.",
            show_when_field="no_upscale",
        ),
        _field(
            "subsample_ratio",
            "Subsample ratio",
